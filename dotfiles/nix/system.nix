          ...
          "New Bookmarks" = [
            {
              ...
              # Status Bar Layout extracted to modules/iterm2.nix
              # See dotfiles/nix/modules/iterm2.nix for complete iTerm2 configuration
              # This modularization improves maintainability and reduces syntax error risk
