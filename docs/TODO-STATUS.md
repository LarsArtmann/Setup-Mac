...
4. Add Darwin networking settings (MEDIUM)
5. Research TouchID authentication (MEDIUM)
6. Re-enable Hyprland type safety (MEDIUM)

**Long Term Priority (This Quarter)**:
7. Move terminal environment to dedicated config (LOW)
8. Move Nixpkgs config to common (LOW)
9. Migrate ActivityWatch to Nix (LOW)
10. Move activation script to environment module (LOW)
