  ...
  config = {
    ...
    users.users.lars = {
      ...
      openssh.authorizedKeys.keys = [
        "ssh-rsa  git@lars.software"
      ];
      packages = with pkgs; [
        firefox
      ];
