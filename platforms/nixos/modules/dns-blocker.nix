        ...
        serviceConfig =
          {
            ...
            ExecStartPre = let
              initScript = pkgs.writeShellScript "dnsblockd-init" ''
                ...
                [ -f /var/lib/dnsblockd/temp-allowlist.json ] || printf '[]' > /var/lib/dnsblockd/temp-allowlist.json
                [ -f /var/lib/dnsblockd/temp-allowlist.json.conf ] || printf '# Auto-generated by dnsblockd - DO NOT EDIT\n' > /var/lib/dnsblockd/temp-allowlist.json.conf
              '';
            in "+${initScript}";
            ExecStart =
