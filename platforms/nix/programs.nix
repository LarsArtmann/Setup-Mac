{ pkgs, lib, ... }:
{
  ...
  programs = {
    ...
    # Enhanced Git configuration - temporarily disabled due to nix-darwin limitations
    # git = {
    #   enable = true;
    ...
    # Enhanced Zsh configuration (fallback shell) - simplified for nix-darwin compatibility
    zsh = {
      enable = true;
      enableCompletion = true;
      # enableSyntaxHighlighting = true; # not available in nix-darwin
      # syntaxHighlighting.enable = true; # not available in nix-darwin
      # autosuggestions.enable = true; # not available in nix-darwin
      # histSize = 50000; # not available in nix-darwin
      # histFile = "$HOME/.zsh_history"; # not available in nix-darwin
      # histFileSize = 50000; # not available in nix-darwin
      # setOptions = [ # not available in nix-darwin
      #   "HIST_VERIFY"
      #   "SHARE_HISTORY"
      #   "EXTENDED_HISTORY"
      #   "HIST_IGNORE_DUPS"
      ...
      #   "CORRECT_ALL"
      # ];
      # shellAliases = { # managed in environment.nix instead
      #   l = "ls -laSh";
      #   t = "tree -h -L 2 -C --dirsfirst";
      #   nixup = "darwin-rebuild switch --flake .";
      #   nixbuild = "darwin-rebuild build --flake .";
    ...
    # Bash configuration for compatibility - temporarily disabled due to nix-darwin limitations
    # bash = {
    #   enable = true;
    ...
    # Starship prompt configuration - temporarily disabled due to nix-darwin limitations
    # starship = {
    #   enable = true;
    #   enableFishIntegration = true;
    #   enableZshIntegration = true;
    #   # enableBashIntegration = true; # disabled due to bash configuration issues
    #   settings = {
